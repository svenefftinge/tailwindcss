...
const OpenLock = '/icons/OpenLock.svg';
const Pin = '/icons/Pin.svg';
const ThreeDots = '/icons/ThreeDots.svg';
...
export function WorkspaceEntry(desc: WorkspaceDescription) {
    ...
    return <div className="whitespace-nowrap flex space-x-2 px-6 py-8 border-b-2 border-gray-100 text-gray-800 w-full justify-between hover:bg-gray-100">
        ...
        <div className="flex w-1/12 self-center space-x-2">
            <div className="w-1/3">
                {desc.shared ? <Image className="m-1 w-4 h-4" src={OpenLock} width={200} height={200} /> : null}
            </div>
            <div className="w-1/3">
                {desc.pinned ? <Image className="w-5 h-6" src={Pin} width={200} height={200} /> : null}
            </div>
            <div className="w-1/3 hover:bg-gray-200">
                <Image className="w-6 h-6" src={ThreeDots} width={200} height={200} />
            </div>
        </div>
    </div>;
}
